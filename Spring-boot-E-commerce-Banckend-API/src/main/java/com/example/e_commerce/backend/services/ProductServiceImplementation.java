...
public class ProductServiceImplementation implements ProductService{
    ...
    @Override
    public Page<Product> findAllProduct(String category, List<String> colors, List<Size> sizes,
                                        String maxPrice, String minPrice, String minDiscount,
                                        String sort, String stock, Integer pageNumber, Integer pageSize) {
        Pageable pageable = PageRequest.of(pageNumber,pageSize);
        List<Product> products = productRepo.filterProducts(category,minPrice,maxPrice,maxPrice,minDiscount,sort);
        if(!colors.isEmpty()){
